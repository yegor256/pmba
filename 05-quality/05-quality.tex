...
\pmbaQuestion
  {ISO 9000 \emph{defines} quality as ...}
...
\pmbaQuestion
  {The architect tells you that 15 bugs can't be fixed in the current release
    and will be \emph{shipped} to the customer. What do you say?}
  {``Cancel the release!''}
...
\pmbaQuestion
  {You just hired a ``\emph{QA} Expert.'' What task would you give him?}
...
\pmbaQuestion
  {You want to increase \emph{quality of product},
    which \emph{metric} would you control first?}
  {Git commits per day}
...
\pmbaQuestion
  {You recruit an external team of testers, how would you \emph{pay} them?}
  {\$100 per hour}
...
\pmbaQuestion
  {Customer complains that the quality is low:
    ...
    How can you find out the \emph{root cause}?}
  {Five Whys}
  {Plan-Do-Check-Act}
  {Six Sigma}
  {Fish-bone Analysis}
...
\pmbaQuestion
  {There are four bugs reported,
    which one would you prioritize as more \emph{important} than others?}
