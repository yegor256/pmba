...
\pmbaQuestion
  {You ask a programmer:
    ``How many \emph{days} will it take to implement a new feature?''
...
\pmbaQuestion
  {A customer asks you to estimate how long it will take for \emph{your team}
...
\pmbaQuestion
  {A potential client asks you how much it would take to make
    a Tetris mobile app. What answer would be the \emph{most accurate}?}
  {A month}
  {More than a month}
...
\pmbaQuestion
  {Some of your programmers complain that
    they sometimes don't know \emph{what to do},
...
\pmbaQuestion
  {A customer asks you to complete the project one month \emph{faster}.
