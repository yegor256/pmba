...
\plush{
\begin{pptWide}{2}
Project Management \hs{Process Groups} and \hs{Knowledge Areas} Mapping:\par
...
\pmbaQuestion
  {You ask a programmer:
    ``How many \hs{days} will it take to implement a new feature?''
    Which answer would you expect and appreciate most of all?}
  {12}
  {10--14}
  {More than 10}
  {10--12--14}
...
\pmbaQuestion
  {A customer asks you to estimate how long it will take for \hs{your team}
    to implement a new feature. What do you do?}
...
\pmbaQuestion
  {A potential client asks you how much it would take to make
    a Tetris mobile app. What answer would be the \hs{most accurate}?}
  {A month}
  {More than a month}
...
\pmbaQuestion
  {Some of your programmers complain that
    they sometimes don't know \hs{what to do},
    which leads to wasted time and frustration. How do you fix this?}
...
\pmbaQuestion
  {There are 5 activities, taking 2 days each,
...
\pmbaQuestion
  {A customer asks you to complete the project one month \hs{faster}.
    How can you do this, as a project manager?}
...
\plush{
  \pptBanner{Homework:}
  ``A \hs{Project Schedule} presents linked activities with planned dates, durations,
