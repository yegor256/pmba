...
\pmbaQuestion
  {In a one-year project, how often do you ask your customer to \emph{sign-off} the budget?}
  {After every weekend}
...
\pmbaQuestion
  {What is the most \emph{honest} way to bill a customer?}
  {\$100 per hour}
...
\pmbaQuestion
  {How to calculate Cost Performance Indicator (\emph{CPI})?}
...
\pmbaQuestion
  {You are a project manager, a programmer \emph{asks} you to pay \$500
...
\pmbaQuestion
  {You just interviewed two programmers and now have to explain
    to your boss that you want to hire the one that is \emph{more expensive};
...
\pmbaQuestion
  {Would you allow your team members \emph{to know} the salaries of each other?}
  {Definitely No!}
