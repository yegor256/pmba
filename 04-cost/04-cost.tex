...
\pmbaQuestion
  {In a one-year project, how often do you ask your customer to \hs{sign-off} the budget?}
  {After every weekend}
...
\pmbaQuestion
  {What is the most \hs{honest} way to bill a customer?}
  {\$100 per hour}
...
\pmbaQuestion
  {How to calculate Cost Performance Indicator (\hs{CPI})?}
...
\pmbaQuestion
  {Which budget looks best of all, in terms of \hs{accuracy} and \hs{precision}?}
  {\$9995.00 \(\pm{}\) 2\%}
  {\$9002.99 \(\pm{}\) 10\%}
  {\$9900.00 \(\pm{}\) 20\%}
  {\$9000.00 \(\pm{}\) 100\%}
...
\pmbaQuestion
  {You are a project manager, a programmer \hs{asks} you to pay \$500
    for a training course about Machine Learning. What do you answer?}
  {``Definitely not!''}
  {``I have to ask our CFO and the customer''}
  {``Only if you work on weekends''}
  {``How is ML related to our project?!''}
  {school}

\pmbaQuestion
  {You just interviewed two programmers and now have to explain
    to your boss that you want to hire the one that is \hs{more expensive};
    what is the best argument to use?}
...
\pmbaQuestion
  {Would you allow your team members \hs{to know} the salaries of each other?}
  {Definitely No!}
...
\plush{
  \pptBanner{Read this:}
  \nospell{Steve McConnell}, \hs{Software Estimation: Demystifying the Black Art} (2006)\par
