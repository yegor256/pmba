...
\pmbaQuestion
  {The estimated duration of the project is 20 months. There is a \emph{3x9} risk that a few key engineers may leave the company soon. If this happens, the project will be delayed by another 15 months. What project duration should you report now to the customer?}
  {\(20 + 15 \times 0.3 = 24.5\)}
