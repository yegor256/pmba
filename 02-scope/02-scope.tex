...
\pmbaQuestion
  {Even though it was not required by the customer, a \emph{programmer} suggests implementing an additional feature in the product, because it is obvious that users will love it; what do you say, as a PM?}
  {``Definitely not!''}
...
\pmbaQuestion
  {Which definition of a task for a \emph{\st{programmer} agent} sounds perfect for you?}
...
\pmbaQuestion
  {A customer asks you how much \emph{work} is left to be done. Where do you find this information?}
  {You ask your team}
  {Use Cases}
  {Backlog}
  {Traceability Matrix}
