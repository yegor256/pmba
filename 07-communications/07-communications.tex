...
\pmbaQuestion
  {A customer \hs{asks}: ``What's up? How is my project going?''
    What do you answer?}
  {Why do you ask?}
  {CPI = 0.85, SPI = 1.12}
...
\pmbaQuestion
  {A new programmer joins your team.
    How do you \hs{explain} the architecture of the software to her?}
...
\pmbaQuestion
  {On a ``Daily Standup'' meeting, one programmer, when \hs{you ask} him
    ``What have you done yesterday'' keeps saying ``I don't remember.''
    How to fix this?}
  {Fire him}
...
\pmbaQuestion
  {You see that meetings in your team take too much time,
    people \hs{waste time} in long and \hs{chaotic} discussions.
    How do you fix this?}
...
\pmbaQuestion
  {After you allowed your team to work \hs{remotely},
    the performance of a few programmers dropped significantly.
    How do you fix this?}
...
\pmbaQuestion
  {Your programmers are paid on a monthly basis, and you can't change this.
    The project is \hs{boring} and team performance is very low.
    What can you do?}
...
\pmbaQuestion
  {A programmer didn't complete his task and explains:
    ``I misunderstood the ticket description''.
    This is caused by \hs{low quality} of what?}
  {Communication}
  {Documentation}
  {Requirements}
  {Motivation}
...
\pmbaQuestion
  {Your \hs{friend} has been promoted, while you know that his
    code contribution is smaller than yours and the quality is lower.
...
\plush{
  \pptBanner{Homework:}
  \begin{multicols}{2}
  ``\hs{Communications Management Plan}'' is a component of a project management plan that describes
