...
\pmbaQuestion
  {A customer \emph{asks}: ``What's up? How is my project going?''
    What do you answer?}
  {Why do you ask?}
  {CPI = 0.85, SPI = 1.12}
...
\pmbaQuestion
  {A new programmer joins your team.
    How do you \emph{explain} the architecture of the software to her?}
...
\pmbaQuestion
  {On a ``Daily Standup'' meeting, one programmer, when \emph{you ask} him
...
\pmbaQuestion
  {You see that meetings in your team take too much time,
    people \emph{waste time} in long and \emph{chaotic} discussions.
    How do you fix this?}
...
\pmbaQuestion
  {After you allowed your team to work \emph{remotely},
...
\pmbaQuestion
  {Your programmers are paid on a monthly basis, and you can't change this.
    The project is \emph{boring} and team performance is very low.
    What can you do?}
...
\pmbaQuestion
  {A programmer didn't complete his task and explains:
    ...
    This is caused by \emph{low quality} of what?}
  {Communication}
  {Documentation}
  {Requirements}
  {Motivation}
...
\pmbaQuestion
  {Your \emph{friend} has been promoted, while you know that his
